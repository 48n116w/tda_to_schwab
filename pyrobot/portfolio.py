...
class Portfolio:
    ...
    def projected_market_value(self, current_prices: dict) -> dict:
        ...
        projected_value["total"]["number_of_profitable_positions"] = (
            position_count_profitable
        )
        projected_value["total"]["number_of_non_profitable_positions"] = (
            position_count_not_profitable
        )
        projected_value["total"]["number_of_breakeven_positions"] = (
